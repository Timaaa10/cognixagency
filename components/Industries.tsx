...
const industries = [
  {
    name: 'Men\'s Elective Procedures',
    benefit: 'High-intent lead qualification for hair restoration, facial optimization, and body contouring specifically for the male market.',
  ...
  },
  {
    ...
    benefit: 'Streamline consultation bookings for premium skin, face, and body treatments with 24/7 AI coverage.',
  ...
  },
  {
    ...
    benefit: 'Automate lead qualification and booking for mortgage brokers, insurance, and wealth management professionals.',

  ...
  return (
    <div className="pt-32 pb-24 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <button 
          onClick={onBack}
          className="mb-8 inline-flex items-center text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors"
        >
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#0a1d37] mb-4">Terms of Service</h1>
        <p className="text-slate-500 font-medium mb-12">Last updated: 23.12.2025</p>

        <div className="prose prose-slate max-w-none text-slate-600 space-y-12">
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">2. Services</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">3. No Guarantees</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">4. Client Responsibilities</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">5. Intellectual Property</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">6. Limitation of Liability</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">7. Third-Party Services</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">8. Termination</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">9. Governing Law</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">10. Changes to Terms</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">11. Contact Information</h2>
            <p className="leading-relaxed">
              For questions regarding these Terms, contact us at:<br />
              <span className="font-bold text-[#0a1d37]">Email: cognix.agency@gmail.com</span>
            </p>
          </section>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-slate-100">
          <button 
            onClick={onBack}
            className="px-8 py-3 bg-[#0a1d37] text-white font-bold rounded-xl hover:bg-slate-800 transition-all shadow-lg"
          >
            Return to Homepage
          </button>
        </div>

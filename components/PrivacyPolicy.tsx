  ...
  return (
    <div className="pt-32 pb-24 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#0a1d37] mb-4">Privacy Policy</h1>
        ...
        <div className="prose prose-slate max-w-none text-slate-600 space-y-12">
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">4. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">5. Cookies & Analytics</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">6. Data Security</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">8. Third-Party Links</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">9. Changes to This Policy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#0a1d37] mb-4">10. Contact Us</h2>
            <p className="leading-relaxed">

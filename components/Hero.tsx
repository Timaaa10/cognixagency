    ...
    <section className="relative pt-24 pb-24 lg:pt-32 lg:pb-40 overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="mt-24 pt-12 border-t border-slate-200 dark:border-navy-800/50 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-10 opacity-80 dark:opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            {industries.map((item, i) => (
              <span key={i} className="text-[11px] md:text-xs font-black text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-default whitespace-nowrap tracking-wider">
                {item}
              </span>
            ))}
          </div>
